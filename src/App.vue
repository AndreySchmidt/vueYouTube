<template>
  <header class="flex fixed justify-between w-full z-30">
    ...
    <div class="flex lg:w-1/4">
        <div class="flex items-center xl:bg-white xl:w-64 pl-4">
            ...
            <a href="" >
                <svg class="w-20" xmlns="http://www.w3.org/2000/svg" viewBox="409.289 277.787 512 114.301">
    ...
    <div class="hidden sm:flex flex-1 justify-end pl-8 md:pl-12 md:px-8 lg:px-0 items-center lg:w-1/2 max-w-md">
        <div class="flex w-full h-full p-2.5">
            <input type="text" placeholder="Search" class="border border-gray-300 w-full px-3 shadow-inner rounded-bl-sm rounded-tl-sm focus:outline-none focus:border-blue-700" />
    ...
    <div class="flex items-center justify-end lg:w-1/4 sm:space-x-3 p-2 sm:px-4">
        ...
        <button class="relative group p-2 focus:outline-none">
            ...
            <div class="hidden group-hover:block flex flex-col absolute top-8 -right-full sm:right-0 bg-white w-72 border border-t-0">
                <section class="py-2 border-b border-gray-200">
                    <ul>
                        <li>
                            <a href="" class="flex items-center px-4 py-2 text-sm hover:bg-gray-100">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-6 text-gray-400">
        ...
        <button class="flex items-center px-2 py-1 text-sm text-blue-700 uppercase border border-blue-700 rounded-sm whitespace-nowrap focus:outline-none">
  ...
  <!-- sidebar md start -->
  <aside class="hidden md:block min-h-screen overflow-auto fixed top-0 pt-14 bg-white z-20">

  <section>
      <ul>
          <li>
              <a href="" class="flex flex-col items-center px-2 py-5 text-red-500 hover:bg-gray-100">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mb-1.5">
      ...
      <ul>
          <li>
              <a href="" class="flex items-center px-6 py-2 text-sm font-medium text-gray-800 bg-gray-200 hover:bg-gray-300">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-6 text-red-600">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
                  </svg>                          
                  <span>
                      Home
  ...
  <section class="py-2 border-b border-gray-100">
      <div class="uppercase text-sm font-semibold px-6 py-2 text-gray-600">Best of youtube</div>
      <ul>
          <li>
              <a href="" class="flex items-center px-6 py-2 text-sm hover:bg-gray-100">
  ...
  <section class="py-2 border-b border-gray-100">
      <ul>
          <li>
              <a href="" class="flex items-center px-6 py-2 text-sm hover:bg-gray-100">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4 mr-6">
  ...
  <section class="py-2 border-b border-gray-100">
      <div class="uppercase text-sm font-semibold px-6 py-2 text-gray-600">More from YouTube</div>
      <ul>
          <li>
              <a href="" class="flex items-center px-6 py-2 text-sm hover:bg-gray-100">
                  <div class="mr-6 p-1">
  ...
  <section class="text-gray-500 px-6 py-4 text-xs font-semibold space-y-4">
      <div>
      ...
      <div class="font-normal">&copy; 2021 Google LLC</div>
  </section>

  </aside>
  <!-- sidebar main end -->
  <!-- sidebar mobile start -->
  <div class="hidden fixed inset-0 bg-black bg-opacity-50 z-40">
  ...
  <!-- sidebar mobile end -->
  <!-- category -->
  <section class="xl:pl-64 md:pl-24 pt-14 fixed bg-white bg-opacity-90 z-10 w-full">
  <div class="border-t border-b px-4 max-w-screen-2xl m-auto">
      <div class="py-3 flex space-x-3 overflow-auto whitespace-nowrap">
          <a href="" class="text-sm px-3 py-1 inline-block rounded-full bg-gray-100 border border-gray-300 hover:bg-gray-200 transition">
              All
          </a>
          <a href="" class="text-sm px-3 py-1 inline-block rounded-full bg-gray-600 border border-gray-700 hover:bg-gray-500 text-white transition">
              Trucks
          </a>
          <a href="" class="text-sm px-3 py-1 inline-block rounded-full bg-gray-100 border border-gray-300 hover:bg-gray-200 transition">
              Machines
  ...
  <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 max-w-screen-2xl m-auto">
      ...
      <div class="group">
          <a href="">
              <div class="relative">
                  <img src="https://picsum.photos/seed/picsum/720/404" />
                  <span class="bg-opacity-60 opacity-0 group-hover:opacity-100 absolute top-0 right-0 text-white bg-black rounded-sm m-1 p-1">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>                  
                  </span>
                  <span class="bg-opacity-60 opacity-0 group-hover:opacity-100 absolute top-8 right-0 text-white bg-black rounded-sm m-1 p-1">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                          <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 5.25h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5m-16.5 4.5h16.5" />
                      </svg>                  
                  </span>
                  <span class="duration-500 opacity-100 group-hover:opacity-0 absolute bottom-0 right-0 text-white bg-black text-xs rounded-sm m-1 p-1 font-semibold">05:45</span>
              </div>
          </a>

          <div class="flex items-start mr-3 mt-2 mb-7">
              <img src="https://picsum.photos/seed/avatar1/68" class="rounded-full mr-3 w-9 h-9" />
              ...
              <button class="ml-auto -mt-1 p-1 opacity-0 group-hover:opacity-100 text-gray-500 hover:text-gray-700 focus:outline-none">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                      <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 12.75a.75.75 0 110-1.5.75.75 0 010 1.5zM12 18.75a.75.75 0 110-1.5.75.75 0 010 1.5z" />
                  </svg>                          
              </button>
