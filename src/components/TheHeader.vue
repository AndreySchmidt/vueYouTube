<template>
  <header class="flex fixed justify-between w-full z-30">
    ...
    <div
      class="hidden sm:flex flex-1 justify-end pl-8 md:pl-12 md:px-8 lg:px-0 items-center lg:w-1/2 max-w-md"
    >
      <div class="flex w-full h-full p-2.5">
        <input
          type="text"
          placeholder="Search"
          class="border border-gray-300 w-full px-3 shadow-inner rounded-bl-sm rounded-tl-sm focus:outline-none focus:border-blue-700"
        />
        <button
    ...
    >
      ...
      <button class="relative group p-2 focus:outline-none">
        ...
        <div
          class="hidden group-hover:block flex flex-col absolute top-8 right-0 sm:left-0 bg-white w-60 border border-t-0"
        >
      ...
      <button class="relative group p-2 focus:outline-none">
        ...
        <div
          class="hidden group-hover:block flex flex-col absolute top-8 -right-full sm:right-0 bg-white w-72 border border-t-0"
        >
          <section class="py-2 border-b border-gray-200">
            <ul>
              <li>
                ...
                >
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="w-6 h-6 mr-6 text-gray-400"
                  >
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
      ...
      <button
        class="flex items-center px-2 py-1 text-sm text-blue-700 uppercase border border-blue-700 rounded-sm whitespace-nowrap focus:outline-none"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
